    ...
    <section style={{ background: 'var(--bg-page)', borderBottom: '1px solid var(--border-light)' }}>
      <div className="max-w-7xl mx-auto px-12 py-20">
        <div className="text-center mb-12">
          ...
          <h2 style={{ fontSize: '34px', letterSpacing: '-1px' }}>See what a risk report looks like</h2>
        ...
        <div className="max-w-3xl mx-auto rounded-2xl overflow-hidden"
          ...
          <div className="flex justify-between items-center px-7 py-5"
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '30px', fontWeight: 600, color: 'var(--text-primary)' }}>6/10</div>
            </div>
          </div>

          {/* Metrics */}
          <div className="grid grid-cols-4" style={{ borderBottom: '1px solid var(--border-light)' }}>
            {[['Monthly EMI', '₹8,500', false], ['Income Usage', '42%', true], ['Disposable', '₹12,000', false], ['Tenure', '24 mo', false]].map(([l, v, warn], i) => (
              <div key={l} className="px-6 py-5" style={{ borderRight: i < 3 ? '1px solid var(--border-light)' : 'none' }}>
          ...
          <div className="grid grid-cols-2">
            <div className="px-6 py-5" style={{ background: '#fff8f5', borderRight: '1px solid var(--border-light)' }}>
            ...
            <div className="px-6 py-5" style={{ background: '#f5fdf7' }}>
